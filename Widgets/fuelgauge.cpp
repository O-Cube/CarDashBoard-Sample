...
void FuelGauge::paintEvent(QPaintEvent *event)
{
    ...
    scales.addText(QPoint(65, 45), scaleFont, tr("1"));
    scales.addText(QPoint(40, 30), scaleFont, tr("0.5"));
    scales.addText(QPoint(15, 45), scaleFont, tr("0"));
    pen.setWidth(1);
    painter.setPen(pen);
...
void FuelGauge::moveGauge(int angle)
{
    m_angle = angle;
    update();
}
